...
func TestTokenMessengerQuerySingle(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			response: &types.QueryGetTokenMessengerResponse{TokenMessenger: msgs[0]},
		},
		{
			desc: "Second",
			request: &types.QueryGetTokenMessengerRequest{
			...
			response: &types.QueryGetTokenMessengerResponse{TokenMessenger: msgs[1]},
		},
		{
			desc: "KeyNotFound",
			request: &types.QueryGetTokenMessengerRequest{
