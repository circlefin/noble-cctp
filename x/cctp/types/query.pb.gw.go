...
var (
	pattern_Query_Roles_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "roles"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Attester_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"circle", "cctp", "v1", "attesters", "attester"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Attesters_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "attesters"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_PerMessageBurnLimit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"circle", "cctp", "v1", "per_message_burn_limits", "denom"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_PerMessageBurnLimits_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "per_message_burn_limits"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BurningAndMintingPaused_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "burning_and_minting_paused"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SendingAndReceivingMessagesPaused_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "sending_and_receiving_messages_paused"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_MaxMessageBodySize_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "max_message_body_size"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NextAvailableNonce_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "next_available_nonce"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SignatureThreshold_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "signature_threshold"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TokenPair_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"circle", "cctp", "v1", "token_pairs", "remote_domain", "remote_token"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TokenPairs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "token_pairs"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_UsedNonce_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"circle", "cctp", "v1", "used_nonces", "source_domain", "nonce"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_UsedNonces_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "used_nonces"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RemoteTokenMessenger_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"circle", "cctp", "v1", "remote_token_messengers", "domain_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RemoteTokenMessengers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "remote_token_messengers"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BurnMessageVersion_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "burn_message_version"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LocalMessageVersion_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "local_message_version"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LocalDomain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"circle", "cctp", "v1", "local_domain"}, "", runtime.AssumeColonVerbOpt(false)))
)
