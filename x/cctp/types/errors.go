...
var (
	...
	ErrTokenMessengerAlreadyFound = sdkerrors.Register(ModuleName, 51, "this token messenger mapping already exists")
	ErrHandleMessage              = sdkerrors.Register(ModuleName, 52, "error during handle message")
	ErrTokenMessengerNotFound     = sdkerrors.Register(ModuleName, 53, "token messenger not found")
